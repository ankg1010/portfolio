(function () {
  ...
  var CONFIG = {
    ...
    stretch:     0.55,            // liquid stretch in direction of motion (0 = none)
    irregularity:0.30,            // organic blob wobble (0 = perfect circle)
  ...
  var tx, ty, ox, oy, pox, poy, dxp, dyp, t0 = performance.now();
  ...
  function loop(now) {
    ...
    orb.style.transform = 'rotate(' + ang + 'rad) scale(' + sx.toFixed(3) + ',' + sy.toFixed(3) + ') rotate(' + (-ang) + 'rad)';
